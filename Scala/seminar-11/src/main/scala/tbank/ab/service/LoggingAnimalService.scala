...
class LoggingAnimalService[F[_]: Monad](service: AnimalService[F])(using logging: LoggingAnimalService.Log[F]) extends AnimalService[F] {
...
object LoggingAnimalService extends LoggingCompanion[LoggingAnimalService] {
  def make[F[_] : Monad](service: AnimalService[F])(using loggingAnimalService: LoggingAnimalService.Log[F]): AnimalService[F] =
